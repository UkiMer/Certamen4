...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adapterUbi = new ArrayAdapter<>(this, android.R.layout.simple_spinner_item, UbicacionS);
    ...
    public void RegistrarProducto(View view) {
        ...
        Cursor fila = BaseDatos.rawQuery("Select * from Inventario_Bodega where ID =" + IDproducto, null);
        if(!fila.moveToFirst()){
            ...
            Toast.makeText(this, "ID del producto ya existe.", Toast.LENGTH_SHORT).show();
        }
    }
